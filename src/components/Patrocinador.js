...
function Patrocinador() {
  return (
    <section className='lg:h-screen flex flex-col justify-center pt-[50px]  items-center h-[100vh]'>
      <div className='flex flex-col justify-center items-center'>
        ...
        <div className='lg:flex flex justify-center flex-row mt-10 gap-[30px] lg:ml-[150px] patracinador '>
        ...
        <button className='text-white p-3 lg:mt-10 mt-10' id='btn'><a href='https://pag.ae/7Zh32We4u'> COMPRAR </a></button>
        <div className='flex flex-col mb-0   justify-center items-center'>
